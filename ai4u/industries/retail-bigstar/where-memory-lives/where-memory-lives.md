...
In Lab 5, you experienced the forgetting problem firsthand. Alex Martinez had to explain her preferences and loyalty discount to three different inventory specialists. The AI assistant forgot everything the moment each session ended.

This isn't just frustrating. It's costing Big Star Collectibles business. Clients feel unvalued. Inventory specialists waste time re-gathering information. And compliance can't track what was communicated.
...
1. Register the "remember" tool.
    ...
    BEGIN
        DBMS_CLOUD_AI_AGENT.CREATE_TOOL(
            ...
            attributes  => '{"instruction": "Store a fact for future reference. Parameters: P_FACT (the information to remember), P_CATEGORY (optional: general, preference, contact, etc), P_ABOUT (optional: the entity this fact is about, e.g. Alex Martinez). Use this when the user shares important information.",
...
2. Tell the agent something to remember.
    ...
    ```sql
    <copy>
    SELECT AI AGENT Customer Alex Martinez prefers to be contacted by email, not phone;
    </copy>
    ```
...
3. Tell it more.
    ...
    ```sql
    <copy>
    SELECT AI AGENT Alex Martinez has a 15 percent loyalty discount and her timezone is Pacific;
    </copy>
    ```
