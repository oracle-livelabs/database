...
## Task 2: Attach Block Volume to Compute Instance   
...
## Task 2: Install Git and clone the pre-built repository
...
## Task 2: Install the Oracle Grid Infrastructure and Database software and configure the cluster and database through Vagrant
...
## Task 2: Configure the Storage pool using virsh
...
## Task 2: Connect to your instance and build your cluster and RAC database
...
## Task 2: Connect to one of the GI Nodes
