...
## Introduction
 ...
 In this workshop, you will learn the fundamentals about the JSON Relational Duality feature, which allows for the seamless integration between the relational and JSON data models. This feature provides the strengths of both approaches, allowing you to easily manipulate data in either model.
...
1. Let us now use REST to work with our Duality Views. We will show this using a macOS native terminal and execute a basic GET request.
...
3. Right-click on the SCHEDULEV, hover the mouse over REST, and click Enable if it isn't already enabled. See the picture below. NOTE: If it is enabled already, it will say Disable… instead. If you see Disable… you don't have to do anything, and your view is already REST enabled. Skip to number 5.
...
5. Here we will use the SQL Developer Web URL to obtain your ADB instance base URL. Alternatively, you can get the ORDS URL from the Tool Configuration tab on the OCI Console :
