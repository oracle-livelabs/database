...
6. Copy and paste the following code in the worksheet and click run script to populate the HR tables. 
    ```
    <copy>
...
7. Copy and paste the following code in the worksheet, and click run script to index the HR tables. 
...
8. Copy and paste the following code in the worksheet, and click run script to create procedural objects for the HR tables.
...
10. Copy and paste the following code in the worksheet, and click run script to gather schema statistics for the HR tables.
...
11. Sign out of sql developer.

## Task 2: Create the table and the procedure
1. Log in to sql developer as HR
...
3. Create a procedure that allows the HR user to raise the employees’ salaries.
    ...
    ```
4. Sign out of sql developer.

## Task 3: Create and enable the audit policy

1. Sign in to sql developer as admin.

2. Create the security officer. The security officer is the one responsible for managing audit policies. Remember to change the password to your own.
...
3. Select the hamburger menu and click Database Users under Administration.
...
6. Create an audit policy that audits any salary increase.
...
8. Sign out of sql developer as auditor_admin.

## Task 4: Audit the user activities including recursive statements

1. Sign in to sql developer as HR.
...
3. Update the row directly and commit.
...
1. Sign in to sql developer as auditor_admin. 

2. Verify that the update actions executed through the PL/SQL procedure and directly by the UPDATE command are audited.
...
3. Sign out of sql developer and sign in as HR.
...
5. Update the row directly and commit.
...
1. Sign out of sql developer and sign in as auditor_admin and verify that the update actions executed through the PL/SQL procedure are not audited.
...
- **Last Updated By/Date** - Nicholas Cusato, Santa Monica Specialist Hub, July 8 2022
