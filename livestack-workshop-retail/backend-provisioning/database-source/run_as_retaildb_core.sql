 ...
 *   1. Connect as ADMIN.
 *   2. Run @retail_workshop_admin_create_lab_seed.sql.
 *   3. Connect as LLUSER and run @verify_retail_workshop_ready.sql if needed.
 */
SET SERVEROUTPUT ON
BEGIN
  RAISE_APPLICATION_ERROR(-20073, 'Deprecated random loader path. Use @retail_workshop_admin_create_lab_seed.sql from ADMIN for compact learner workshop data.');
END;
/
