...
2. Sign in to the Oracle Backend for Firebase Anywhere console with the workshop credentials.
    ...
    ![Oracle Backend for Firebase Anywhere console navigation after the page loads](./images/task-4-console-navigation.png )
...
4. In the **Create Project** dialog:
    ...
    > This step creates the Fusabase project. A project is like a container for the different applications that you want to create. 
