...
4. In the **Create Project** dialog:
    ...
    > This step creates the Fusabase project. A project is like a container for the different applications that you want to create. To learn more about projects, read about them in the docs.
