...
## Task 3: Download the demo environment for Fusabase
...
2. Create a new directory for the workshop files and move into it.
    ...
    ```bash
    <copy>mkdir fusabase-workshop
    cd fusabase-workshop</copy>
    ```

3. Clone the repository that contains the Fusabase demo environment.

    ```bash
    <copy>git clone https://github.com/KillianLynch/UPDATE-WITH-CURRENT-COMPOSE.git fusabase-demo</copy>
    ```

4. Move into the cloned repository directory.

    ```bash
    <copy>cd fusabase-demo</copy>
    ```
...
5. Confirm that the repository includes the files and folders used by the demo environment.
    ...
    ![The fusabase-demo directory showing compose.yaml and the supporting folders for the Fusabase demo environment](images/task-3-demo-files-terminal.png =30%x*)

## Task 4: Start the demo environment

1. Make sure you are in the `fusabase-demo` directory.
