...
1. Use the *yellow* terminal 🟨. Set the environment to the *CDB26* database. Now, since you upgraded the *UPGR* database and plugged into *CDB26*, the environment needs to be set to the CDB.
