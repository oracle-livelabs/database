...
## Introduction
Welcome to Oracle AI Database Private Agent Factory Hands-on workshop. This workshop will guide you through the **Oracle AI Database Private Agent Factory (Agent Factory)**, and demonstrate how enterprise is rapidly building and deploying Generative AI Agents privately and securely.

**Estimated time:** 5 minutes.

### Objectives

1. Build your first Agents in Lab 1 (Knowledge and Data Analysis Agents) 
2. Build database specific agents by connecting to EBS Database directly and through OIC in Lab 2 & 3
3. Build custom workflow agent in Lab 4
