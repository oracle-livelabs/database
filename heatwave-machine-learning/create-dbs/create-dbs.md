...
1. Sign in to Oracle Cloud, and click **Navigation menu**.
...
7. Review Oracle Virtual Cloud Network (VCN), Subnets, and Gateways, and click **Create** to create the VCN.
...
8. On the **Add Ingress Rules** page under **Ingress Rule**, add an Ingress Rule with the following details:
    Source CIDR
...
1. Navigate to **Navigation Menu** > **Networking** > **Virtual cloud networks**.
...
## Task 5: Create a MySQL HeatWave instance

1. Click **Navigation Menu** > **Databases** > **MySQL HeatWave**.
...
- **Last Updated By/Date** - Aijaz Fatima, Product Manager, October 2025
