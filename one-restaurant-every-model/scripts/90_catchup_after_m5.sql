...
-- Duality views created + REST-enabled; chain price at 14.99; the local
...
USING (SELECT m.menu_id, 1000 AS item_id, 13.50 AS price
...
-- STATE CHECK: expect BASE_PRICE_1000 14.99, RIVERSIDE_1000 13.50, DOCS 5
