...
-- Produces: four stores at 1399; s_104's drifted string copy ("1000") untouched
-- at its local premium of 1499 - Lab 4's see-the-drift step depends on it.
-- STATE CHECK below: expect s_100..s_103 = 1399, s_104 = 1499.
@01_seed_stores.sql
@02_price_change.sql
