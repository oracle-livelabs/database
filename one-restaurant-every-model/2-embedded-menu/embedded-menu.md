...
1. In **mongosh**, paste the seed. Five stores; note that **all five sell the Classic Cheeseburger (`item_id: 1000`)** — chain menu, chain item. That detail becomes load-bearing in Lab 3.
    ...
    Two deliberate wrinkles, both of which real franchises have. **Downtown lists item 1000 as "Lunch Classic"** — a location marketing the chain's burger under its own name, not drift. And **the Airport charges its own prices**: 12.49 for that burger, not following the chain's minimum recommendation of $12.99. Everything else inherits from corporate. Lab 4 gives those local decisions a place to live; Lab 5 shows the engine letting a location change its own name and price while refusing to let it rewrite the chain catalog.
            ...
            "categories": [
              {
                ...
                "items": [
                  ...
                  },
                  {
                    ...
                    "description": "Two smash patties, thick-cut bacon, smoked gouda",
                    "price": 15.99,
                    "active": true
                  }
                ]
            ...
            "categories": [
              {
                ...
                "items": [
                  ...
                  },
                  {
                    ...
                    "description": "Smoky black bean patty, fiery chipotle aioli, no meat",
                    "price": 11.99,
                    "active": true
                  }
                ]
            ...
            "categories": [
              {
                ...
                "items": [
                  ...
                  },
                  {
                    ...
                    "description": "Crispy chicken thigh, cayenne hot sauce, blue cheese",
                    "price": 13.49,
                    "active": true
                  }
                ]
              },
              {
                ...
                "items": [
                  ...
                  },
                  {
                    ...
                    "description": "Hand-spun chocolate malt, whole milk, whipped cream",
                    "price": 5.99,
                    "active": true
                  }
                ]
    ...
    **What you should see:** `insertedCount: 5` (mongosh prints it as `insertedIds` with five entries and `acknowledged: true`).
    ...
    > Look closely at `s_104`: an old ingest script wrote all of its `item_id` as **string**, e.g. `"1000"`. Nothing complained. Remember that.
...
> A JSON collection created through the MongoDB API is also reachable through **SODA** and **REST**, Oracle's native document API — same collection, another door. We don't exercise SODA today.

## Learn More

* [Modeling for the Access Pattern (Ask Tom series)](https://www.youtube.com/watch?v=uJdUnB_cb1c)
* [Oracle Simple Document Access (SODA)](https://docs.oracle.com/en/database/oracle/simple-oracle-document-access/)
