...
1. Download [db-23cfree-install.zip]() to a directory on your local computer.
...
14. In a browser, paste the address to your compute instance and wait between 30 and 60 seconds.
