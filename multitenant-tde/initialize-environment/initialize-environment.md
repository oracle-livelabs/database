...
The tasks you will do in this step are:
    - Add the sql scripts to the server 
...
![Screen Capture of Wallet Check](./tde-images/wallet_check_CDB2.png " ")
...
3. Define the application "wmStore" master.
    ...
    ```
    <copy>
    conn system/Ora_DB4U@localhost:1521/wmStore_Master;
    </copy>
    ```

    ```
    <copy>
    alter pluggable database application wmStore begin install '1.0';</copy>
    ```
    ...
    ```
    <copy>
    create user wmStore_Admin identified by Ora_DB4U container=all;
    </copy>
    ```
    ...
    ```
    <copy>
    connect wmStore_Admin/Ora_DB4U@localhost:1521/wmStore_Master
    </copy>
    ```
