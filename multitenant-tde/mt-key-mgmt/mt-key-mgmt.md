...
1. Run this script to set the master encryption key for CDB1 and PDB1
...
2. Run this script to set the master encryption key for CDB2 and PDB2
...
1. Unplug pdbclone1
    ...
    - This also takes a copy of the Master Encryption Key
