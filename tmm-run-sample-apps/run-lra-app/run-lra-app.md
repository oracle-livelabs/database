...
3. Verify that all resources, such as pods and services, are ready. Use the following command to retrieve the list of resources in the namespace `otmm` and their status.
    ...
    pod/otmm-tcs-0     2/2         Running         7 (33m ago)   1d

    NAME               TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)    AGE
    service/otmm-tcs   ClusterIP   10.109........  <none>        9000/TCP   1d

    NAME                      READY       UP-TO-DATE      AVAILABLE     AGE
    deployment.apps/otmm-tcs  1/1         1               1             1d

    NAME                                 DESIRED     CURRENT         READY         AGE
    replicaset.apps/otmm-tcs-84b87b66bd  1           1               1             1d
    ```
