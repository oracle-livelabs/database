...
1. Select the button below. It opens OCI Resource Manager's **Create stack**
    ...
    The button loads this release ZIP: [my-ai-staff-oci-stack-v1.0.0.zip](https://c4u02.objectstorage.us-ashburn-1.oci.customer-oci.com/p/9DEArLjsgbKXuJgQtSG95E8hMXRFtxgHR8jiHbqz4HgyVYXVnSo0SC_s-zq5CJA3/n/c4u02/b/hosted-files/o/my-ai-staff-oci-stack-v1.0.0.zip).
