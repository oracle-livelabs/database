...
<if type="livelabs">
    - __Database Name__ - Use letters and numbers only, starting with a letter. Maximum length is 14 characters. (Underscores not initially supported.) For this lab, use __TEXTDB__ and append your LiveLabs user id. For example, __TEXTDB7199__.
...
7. Create administrator credentials:
    ...
    - __Password and Confirm Password__ - Supply a password for the ADMIN user of the service instance and confirm the password.
